...
if(l.hideOnSwipe){var n=!1,s=20,c=50
switch(l.side){case"left":n=s>a&&a>-1*s&&e>c
break
case"right":n=s>a&&a>-1*s&&-1*c>e
break
case"top":n=s>e&&e>-1*s&&a>c
break
case"bottom":n=s>e&&e>-1*s&&-1*c>a}if(n)return i.touchPosX=null,i.touchPosY=null,i._hide(),!1}(i.scrollTop()<0&&0>a||o>r-2&&r+2>o&&a>0)&&(t.preventDefault(),t.stopPropagation())}}),i.on("click touchend touchstart touchmove",function(t){t.stopPropagation()}),i.on("click",'a[href="#'+n+'"]',function(t){t.preventDefault(),t.stopPropagation(),l.target.removeClass(l.visibleClass)}),r.on("click touchend",function(t){i._hide(t)}),r.on("click",'a[href="#'+n+'"]',function(t){t.preventDefault(),t.stopPropagation(),l.target.toggleClass(l.visibleClass)}),l.hideOnEscape&&o.on("keydown",function(t){27==t.keyCode&&i._hide(t)}),i},t.fn.placeholder=function(){if(void 0!==document.createElement("input").placeholder)return t(this)
if(0==this.length)return a
if(this.length>1){for(var e=0;e<this.length;e++)t(this[e]).placeholder()
return a}var a=t(this)
return a.find("input[type=text],textarea").each(function(){var e=t(this);(""==e.val()||e.val()==e.attr("placeholder"))&&e.addClass("polyfill-placeholder").val(e.attr("placeholder"))}).on("blur",function(){var e=t(this)
